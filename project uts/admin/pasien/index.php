...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Data Pasien Puskesmas Balajaya</h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Data Pasien Puskesmas Balajaya</h3>
                        ...
                        <div class="card-body">
                            <a href="add.php"><button class="btn btn-primary mb-1">Tambah Data Pasien</button></a>
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>ID</th>
