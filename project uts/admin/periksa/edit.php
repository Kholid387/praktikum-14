...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    // Query to fetch data of the examination based on its ID
...
if (isset($_POST['submit'])) {
    ...
    // Query to update examination data based on its ID
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Data Periksa Puskesmas Balajaya</h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Data Periksa Puskesmas Balajaya</h3>
